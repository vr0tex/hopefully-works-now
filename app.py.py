...
for required_asset in ("ag.png", "als.png", "av.png", "sp.png", "G2QVvk8O_400x400.jpg"):
    if not os.path.isfile(os.path.join(ASSETS_DIR, required_asset)):
        print(f"WARNING: Missing asset: {os.path.join(ASSETS_DIR, required_asset)}")
...
class JoinMethodView(discord.ui.View):
    ...
    async def finalize_ticket(self, interaction: discord.Interaction, method: str, username: str, goal: str):
        ...
        ticket_files = []
        logo_path = os.path.join(ASSETS_DIR, "setup_header.png")
...
class ParadoxTicketView(discord.ui.View):
    ...
    async def select_callback(self, interaction: discord.Interaction):
        try:
            ...
            game_image = os.path.join(ASSETS_DIR, game_image_name) if game_image_name else None
...
async def setup(ctx):
    embed = V2Embed()
    file = None
    setup_header_path = os.path.join(ASSETS_DIR, "setup_header.png")
