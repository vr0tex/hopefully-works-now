...
def create_vouch_embed(customer, booster, game, feedback, total_vouches, ticket_id):
    ...
    embed.add_field(name="⭐ Rating", value="⭐⭐⭐⭐⭐ (5/5)", inline=False)
...
class JoinMethodView(discord.ui.View):
    ...
    async def finalize_ticket(self, interaction: discord.Interaction, method: str, username: str, goal: str):
        ...
        await channel.send(content=ping_content, embed=embed, view=TicketControlView(customer_id=user.id, game_id=self.game_id))
    ...
    async def select_callback(self, interaction: discord.Interaction):
        try:
            ...
            if os.path.exists(game_image):
                file = discord.File(game_image, filename=f"{game_id.lower()}.png")
