...
class TicketControlView(discord.ui.View):
    ...
    async def claim_button(self, interaction: discord.Interaction, button: discord.ui.Button):
        ...
        specific_role_id = role_map.get(game.upper())
...
class JoinMethodView(discord.ui.View):
    ...
    async def finalize_ticket(self, interaction: discord.Interaction, method: str, username: str, goal: str):
        ...
        specific_role_id = role_map.get(self.game_id)
...
class ParadoxTicketView(discord.ui.View):
    ...
    async def select_callback(self, interaction: discord.Interaction):
        try:
            ...
            # Use Paradox logo as thumbnail instead of bot's Discord avatar
            files = []
            logo_path = os.path.join("assets", "setup_header.png")
            if os.path.exists(logo_path):
                logo_file = discord.File(logo_path, filename="paradox_logo.png")
            ...
            if os.path.exists(game_image):
                game_file = discord.File(game_image, filename=f"{game_id.lower()}.png")
                embed.set_image(url=f"attachment://{game_id.lower()}.png")
                files.append(game_file)
            elif os.path.exists("assets/setup_header.png"):
                header_file = discord.File("assets/setup_header.png", filename="header.png")
